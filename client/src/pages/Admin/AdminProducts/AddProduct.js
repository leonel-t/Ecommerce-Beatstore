    ...
    try {
      ...
      return await axios.request(options).then(function (response) {
        ...
        categories.forEach(async (element) => {
          return await axios.post(`${serverUrl}/products/${idProduct}/category/${element.value}`).then((res) => console.log(res));
        })
        swal({
          title: "item added",
          icon: "success",
        ...
        ? (
          <>
            ...
            <div className="--add-product-new-container"> 
              <form className=".--add-product-newform" onSubmit={(e) => handleSubmit(e)}>
                ...
                <div  className="--add-product-newform-col-0">
                  ...
                  <div className="--add-product-newform-col-1">
                      <div className="--add-product-newform-col-1-interna-1">
                          ...
                          <div className="--colum-helper --add-product-newform-name">
                          ...
                          <div className=" --colum-helper --add-product-newform-description">
                          ...
                          <div className="--colum-helper --add-product-newform-artist">
                          ...
                          <div className="--colum-helper --add-product-newform-price">
                      ...
                      <div className="--add-product-newform-col-1-interna-2">
                        ...
                        <div className="--colum-helper --add-product-newform-date">
                        ...
                        <div className="--colum-helper --add-product-newform-image">
                        ...
                        <div className="--colum-helper --add-product-newform-audio">
